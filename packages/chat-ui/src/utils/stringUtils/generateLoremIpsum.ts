import { randomInt } from '../numberUtils/randomInt';
...
const loremMaxLength = loremArray.length;

export const generateLoremIpsum = (count: number) => {
  const len = Math.min(count, loremMaxLength);
