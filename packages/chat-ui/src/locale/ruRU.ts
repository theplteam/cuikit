...
export const ruRU: Localization = {
  ...
  threadActionRename: 'Переименовать',
  threadActionPin: 'Закрепить',
  threadActionUnpin: 'Открепить',
  threadRenameTitle: 'Переименование диалога',
  threadRenameLabel: 'Название диалога',
  save: 'Сохранить',
  maxAttachmentWarning: 'Превышено максимальное количество прикрепленных файлов',
  maxFileSizeWarning: 'Размер файла не может превышать {{mb}} МБ',
  invalidFileTypeWarning: 'Тип файла не поддерживается',
